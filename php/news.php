 ...
 //Caso não tenha nenhum item
	 ...
	 for($i = 0; $i<$n; $i++) { 
		...
		if(!mail($to, $subject, $mensagemHTML, $headers ,"-r".$emailsender)){ // Se for Postfix
            ...
            mail("contato@lerin.com.br", $subject, $mensagemHTML, $headers );
